...
class Config(ClassDict):
    ...
    dir_save_dataset: str = "/home/stephen-reilly/dev/virne/dataset/results-4"
    ...
    #pretrained_model_path: str = '/home/stephen-reilly/dev/virne/dataset/results-4/output/output/model/model-worker0-epoch29.pkl'
    ...
    batch_size: int = 125
    target_steps: int = 250 # changed by me was 128 
