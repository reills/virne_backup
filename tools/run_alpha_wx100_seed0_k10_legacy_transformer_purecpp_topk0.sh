...
CONFIG_PATH="results/journal_suite/wx100_seed0_k10_legacy_transformer_purecpp_topk0.yaml"
PROFILE="wx100_seed0_k10_legacy_transformer_purecpp_topk0"
...
cfg.journal_suite.scenarios.nominal_legacy_purecpp_transformer_topk0 = OmegaConf.create({
    'train_split': 'train',
    'eval_split': 'test',
...
cfg.journal_suite.profiles.$PROFILE = OmegaConf.create({
    'seeds': [0],
    'topologies': ['wx100'],
    'scenarios': ['nominal_legacy_purecpp_transformer_topk0'],
