...
CONFIG_PATH="results/journal_suite/wx100_seed0_k10_legacy_transformer_pytrain.yaml"
PROFILE="wx100_seed0_k10_legacy_transformer_pytrain"
...
cfg.journal_suite.scenarios.nominal_legacy_pytrain_transformer = OmegaConf.create({
    'train_split': 'train',
    'eval_split': 'test',
...
cfg.journal_suite.profiles.$PROFILE = OmegaConf.create({
    'seeds': [0],
    'topologies': ['wx100'],
    'scenarios': ['nominal_legacy_pytrain_transformer'],
