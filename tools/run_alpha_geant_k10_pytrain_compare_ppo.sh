...
CONFIG_PATH="results/journal_suite/geant_k10_pytrain_compare_ppo.yaml"
PROFILE="geant_k10_pytrain_compare_ppo"
...
echo "  $ROOT_DIR/datasets/generated/journal/nominal/geant/seed_0/train"
echo "  $ROOT_DIR/datasets/generated/journal/nominal/geant/seed_1/train"
echo "  $ROOT_DIR/datasets/generated/journal/nominal/geant/seed_2/train"
echo "Using eval datasets:"
echo "  $ROOT_DIR/datasets/generated/journal/nominal/geant/seed_0/test"
echo "  $ROOT_DIR/datasets/generated/journal/nominal/geant/seed_1/test"
echo "  $ROOT_DIR/datasets/generated/journal/nominal/geant/seed_2/test"
